...
namespace FoodHub.Data
{
    public static class SeedData
    {
        public static async Task Initialize(IServiceProvider serviceProvider, string testUserPw)
        {
            ...
            var adminID = await EnsureAdmin(serviceProvider, testUserPw, adminUsername);
        ...
        private static async Task<string> EnsureAdmin(IServiceProvider serviceProvider,
